...
(async () => {
    ...
    try {
        ...
        if (bodyText.includes('config_') || bodyText.includes('module_') || bodyText.includes('common_')) {
            console.log('WARNING: Found untranslated keys in the page text. Language is broken.');
        }
