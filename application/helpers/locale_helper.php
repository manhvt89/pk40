...
function print_barcode_gong_1x75($items,$barcode_config)
{
    ...
    if (!empty($items)) {
			...
			foreach ($items as $item) {
                ...
                $_sHtml = $_sHtml . '<div class="2" style="border: 1px blue dot;  width: 50mm; height:45mm; float:right; text-align: center; transform: rotate(90deg);margin:0mm 0mm 0mm 0mm;">';
